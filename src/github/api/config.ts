...
export const FORGE_TYPE = (process.env.FORGE_TYPE || 'github') as 'github' | 'forgejo';
export const FORGE_API_URL = process.env.FORGE_API_URL || 
  (FORGE_TYPE === 'github' ? GITHUB_API_URL : "https://forgejo.example.com/api/v1");
export const FORGE_SERVER_URL = process.env.FORGE_SERVER_URL || 
